...
<script>
    $(function notification() {
        new PNotify({
            title: "Error",
            type: "error",
            text: "El usuario o el email ya están en uso",
            styling: "bootstrap3"
        });
    });
</script>
...
<div class="page-content">
    <h4 class="text-center text-secondary">PERFIL USUARIO</h4>
    ...
    <div class="row">
        <form action="../controlador/controladorModificarPerfil.php" method="POST">
